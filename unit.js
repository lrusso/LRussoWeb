...
describe("Emulatrix/index.html", function () {
  it("Should exist", function () {
    expect(fileExists("Emulatrix/index.html")).toBe(true)
  })

  it("Should not have changed", function () {
    const expectedHash = "55fd55fc"
    let currentHash = ""

    try {
      const content = readFileSync("Emulatrix/index.html", "utf8")
      currentHash = generateHash(content)
    } catch (err) {
      currentHash = ""
    }
  ...
  it("Should define the i18n variable", function () {
    const variableExists = getVariable("Emulatrix/index.html", "APP_STRINGS")
    expect(variableExists).not.toBe("")
  })
