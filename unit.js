...
describe("DOS/index.html", function () {
  it("Should exist", function () {
    expect(fileExists("DOS/index.html")).toBe(true)
  })

  it("Should not have changed", function () {
    const expectedHash = "2a45c80d"
    let currentHash = ""

    try {
      const content = readFileSync("DOS/index.html", "utf8")
      currentHash = generateHash(content)
    } catch (err) {
      currentHash = ""
    }
